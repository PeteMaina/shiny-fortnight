        ...
        <Container maxWidth="xl">
          ...
          {tabValue === 1 && (
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                <Card sx={{ borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                  <CardHeader title="Weather Impact Analysis" titleTypographyProps={{ variant: 'h6', fontWeight: 'bold' }} />
                  <CardContent>
                    <Stack spacing={2}>
                      <Box>
              ...
              <Grid item xs={12} md={6}>
                <Card sx={{ borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                  <CardHeader title="Predictive Insights" titleTypographyProps={{ variant: 'h6', fontWeight: 'bold' }} />
                  <CardContent>
                    <Stack spacing={2}>
          ...
          {tabValue === 2 && (
            <Grid container spacing={3}>
                  ...
                  <CardContent>
                    <Stack spacing={3}>
                      ...
                      <FormControl fullWidth>
                        ...
                        <Select value={cropType} label="Crop Type" onChange={(e) => onSetCropType(e.target.value)}>
                          <MenuItem value="corn">Corn</MenuItem>
                          <MenuItem value="wheat">Wheat</MenuItem>
                          <MenuItem value="tomatoes">Tomatoes</MenuItem>
                          <MenuItem value="soybeans">Soybeans</MenuItem>
                      ...
                      <Stack direction="row" spacing={1}>
                        <Button variant="contained" startIcon={<PlayArrow />} disabled={autoIrrigation} fullWidth>
                          Start Irrigation
                        </Button>
                        <Button variant="outlined" startIcon={<Stop />} disabled={autoIrrigation} fullWidth>
                          Stop
                        </Button>
                      </Stack>
                    </Stack>
              ...
              <Grid item xs={12} md={6}>
                <Card sx={{ borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                  <CardHeader title="Fertilizer Management" titleTypographyProps={{ variant: 'h6', fontWeight: 'bold' }} />
                  <CardContent>
                    <Accordion>
                      ...
                      <AccordionDetails>
                        <Stack spacing={2}>
                          <TextField label="Amount (kg/ha)" type="number" defaultValue={120} size="small" />
              ...
              <Grid item xs={12}>
                <Card sx={{ borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                  <CardHeader title="Equipment Control" titleTypographyProps={{ variant: 'h6', fontWeight: 'bold' }} />
                  <CardContent>
